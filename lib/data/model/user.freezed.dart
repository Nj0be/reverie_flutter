...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeToJson: false)  String id,  String email,  String username,  String name,  String surname,  List<String> diaryIds,  List<String> sentTimeCapsuleIds,  List<String> receivedTimeCapsuleIds)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _User() when $default != null:
return $default(_that.id,_that.email,_that.username,_that.name,_that.surname,_that.diaryIds,_that.sentTimeCapsuleIds,_that.receivedTimeCapsuleIds);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeToJson: false)  String id,  String email,  String username,  String name,  String surname,  List<String> diaryIds,  List<String> sentTimeCapsuleIds,  List<String> receivedTimeCapsuleIds)  $default,) {final _that = this;
switch (_that) {
case _User():
return $default(_that.id,_that.email,_that.username,_that.name,_that.surname,_that.diaryIds,_that.sentTimeCapsuleIds,_that.receivedTimeCapsuleIds);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(includeToJson: false)  String id,  String email,  String username,  String name,  String surname,  List<String> diaryIds,  List<String> sentTimeCapsuleIds,  List<String> receivedTimeCapsuleIds)?  $default,) {final _that = this;
switch (_that) {
case _User() when $default != null:
return $default(_that.id,_that.email,_that.username,_that.name,_that.surname,_that.diaryIds,_that.sentTimeCapsuleIds,_that.receivedTimeCapsuleIds);case _:
  return null;
