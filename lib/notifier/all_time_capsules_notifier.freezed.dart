...
/// Adds pattern-matching-related methods to [AllTimeCapsulesState].
extension AllTimeCapsulesStatePatterns on AllTimeCapsulesState {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AllTimeCapsulesState value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AllTimeCapsulesState() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AllTimeCapsulesState value)  $default,){
final _that = this;
switch (_that) {
case _AllTimeCapsulesState():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AllTimeCapsulesState value)?  $default,){
final _that = this;
switch (_that) {
case _AllTimeCapsulesState() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@protected  Map<String, TimeCapsule> sentTimeCapsules, @protected  Map<String, TimeCapsule> receivedTimeCapsules,  TimeCapsuleType buttonState,  String deleteDialogCapsuleId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AllTimeCapsulesState() when $default != null:
return $default(_that.sentTimeCapsules,_that.receivedTimeCapsules,_that.buttonState,_that.deleteDialogCapsuleId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@protected  Map<String, TimeCapsule> sentTimeCapsules, @protected  Map<String, TimeCapsule> receivedTimeCapsules,  TimeCapsuleType buttonState,  String deleteDialogCapsuleId)  $default,) {final _that = this;
switch (_that) {
case _AllTimeCapsulesState():
return $default(_that.sentTimeCapsules,_that.receivedTimeCapsules,_that.buttonState,_that.deleteDialogCapsuleId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@protected  Map<String, TimeCapsule> sentTimeCapsules, @protected  Map<String, TimeCapsule> receivedTimeCapsules,  TimeCapsuleType buttonState,  String deleteDialogCapsuleId)?  $default,) {final _that = this;
switch (_that) {
case _AllTimeCapsulesState() when $default != null:
return $default(_that.sentTimeCapsules,_that.receivedTimeCapsules,_that.buttonState,_that.deleteDialogCapsuleId);case _:
  return null;
